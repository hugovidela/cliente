                  ...
                  <v-card-text>
                    <v-row>
                      <v-col cols="12" sm="12" md="12" class="pl-6 pt-6 bt-0">
                        ...
                        <v-row>
                          <v-col cols="12" md="6" class="pl-7 pt-0">
                          ...
                          <v-col cols="12" md="2" class="pl-7 pt-0">
                            <v-text-field
                        ...
                        <v-row>
                          <v-col cols="12" class="pl-7 pt-0">
                            <span>
                              <b>Importante</b><br>
                              Los descuentos 1 y 2 aplicarán a todos los artículos, y
                              los descuentos definidos en Grupos, Marcas y/o Artículos
                              aplicarán solo a los artículos incluidos en los mismos.
                            </span>
                          </v-col>
                        </v-row>
                                  ...
                                  <v-dialog v-model="dialogMarca" max-width="600px"
                                    ...
                                    <v-card class="fg">
                                      <v-toolbar flat
                                        ...
                                        <v-spacer></v-spacer>
                                        <v-btn
                                          v-if="(editadoMarca.marca_id&&editadoMarca.desc1)"
                                          color="teal accent-4" class="ma-2 white--text"
                                  ...
                                  <v-dialog v-model="dialogArticulo" max-width="600px"
                                    ...
                                    <v-card class="fg">
                                      <v-toolbar flat
                                        ...
                                        <v-spacer></v-spacer>
                                        <v-btn
                                          v-if="(editadoArticulo.nombre&&editadoArticulo.desc1)"
                                          color="teal accent-4" class="ma-2 white--text"
...
export default {
  ...
  data: () => ({
    ...
    editadoLista: {
      id: null, nombre: null, medio_id: null, dias: null, grupos: [], marcas: [], articulos: [], desc1: null, desc2: null, activo: null,
    },

    editadoDefaultLista: {
      id: null, nombre: null, medio_id: null, dias: null, grupos: [], marcas: [], articulos: [], desc1: null, desc2: null, activo: true,
    },

    editadoGrupo: {
      id: null, grupo_id: null, nombre: null, desc1: null, desc2: null,
    },
    ...
    editadoMarca: {
      id: null, marca_id: null, nombre: null, desc1: null, desc2: null
    },
    ...
    editadoArticulo: {
      id: null, codigo: null, articulo_id: null, nombre: null, desc1: null, desc2: null,
    },
