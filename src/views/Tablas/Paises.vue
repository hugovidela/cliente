...
export default {
  ...
  data: () => ({
    ...
    headers: [
      ...
      { text: 'CODIGO', value:'codigo', width: "90"},
      { text: 'NOMBRE', value:'nombre', width: "250"},
      { text: 'CARACT.TEL', value:'caract_tel', width: "130"},
 ...
 methods: {
   ...mapMutations(['alert','closeAlert']),
    ...
    preguntoBorrar (item) {
      ...
      debugger
      return HTTP().get(`/paispuedoborrar/${item.id}`).then((data) => {
        debugger
        if (data.data=='ok') {
          ...
          this.msg.msgTitle = 'Borrar'
          this.msg.msgBody = 'No se puede borrar este País, esta siendo utilizado por una o mas Provincias.'
          this.msg.msgVisible = true
