...
export default {
  ...
  data: () => ({
    ...
    headers: [
      ...
      { text: 'Usuario',  value:'username', align: 'left',   width: 120 },
      { text: 'Clase',    value:'tipo',     align: 'left',   width: 50 },
      { text: 'Tipo',     value:'externo',  align: 'left',   width: 60 },
  ...
  methods: {
    ...mapMutations([
      ...
      'setNotificaciones', 'setCaja', 'setVinculasPadres', 'setVinculasHijos', 'setEmpresa',
    ]),
